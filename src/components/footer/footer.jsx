        ...
        <div className='footer-container'>
                    ...
                    <div className="footer-redesSociales-contact">
                        <div className="mumbexInfo-info-contact ">
                            <div className="mumbexInfo ">
                                ...
                                <h3>Software para gestion empresarial</h3>
                                <h3>Implementacion de bases de datos</h3>

                            </div>
                            <div className="mumbexContacto ">
                                <h2>Contacto</h2>
                                <h3><span><FaMapMarkerAlt /></span> Guinea Ecuatoria, Malabo</h3>
                                <h3><span><FaMobileAlt /></span> +240 222 058 540 /+240 222 707 070</h3>
                                <h3><span><HiMail /></span> mumbexsoft@gmail.com</h3>
            ...
            { <div className="footerFinal">
                ...
                <div className="menuFooter">
                    ...
                    <Link style={{display:"none"}} className='items' to="/blog">Blog</Link>
                </div>
            </div> }
        </div>
    )
